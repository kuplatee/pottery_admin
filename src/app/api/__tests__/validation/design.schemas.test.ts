...
} from '../../graphql/graphql-server/validation/schemas/design.schemas'
...
describe('validateCreateDesign', () => {
  ...
  it('rejects missing details', () => {
    ...
    expect(() => validateInput(validateCreateDesign, rest)).toThrow(
      ValidationError
    )
  })
...
describe('validateUpdateDesign', () => {
  ...
  it('rejects missing id', () => {
    expect(() => validateInput(validateUpdateDesign, validInput)).toThrow(
      ValidationError
    )
  })
})
